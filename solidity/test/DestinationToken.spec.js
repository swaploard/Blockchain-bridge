...
const NAME = 'DestinationToken'
const SYMBOL = 'D-CHSD'

// Start test block
describe('DestinationToken contract', function () {
  before(async function () {
    tokenFactory = await ethers.getContractFactory('DestinationToken')
  ...
  it('Allows bridge to mint tokens for users', async function () {
    console.log("logs", bridge.address, user2.address)
